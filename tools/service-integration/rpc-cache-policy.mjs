...
export const readMethods=new Set(['eth_chainId','eth_getBlockByNumber','eth_getBlockByHash','eth_getBlockReceipts','eth_getLogs','eth_getTransactionReceipt','eth_getCode','eth_call','eth_getBalance','eth_getStorageAt','eth_getTransactionCount','eth_gasPrice','eth_estimateGas','eth_maxPriorityFeePerGas']);
