...
export function serviceEnvironment(values,service,inherited=process.env){
 ...
 const serviceKeys={
  ...
  pipeline:/^(TG_PIPELINE_|TG_CHAIN_JOB_|TG_RPC_|TG_SECONDARY_RPC_URL$|TG_REPAIR_TOKEN$|TG_ALLOWED_ORIGINS$|TG_ENVIRONMENT$|TG_ENV$|TG_CHAIN_ID$|TG_DATABASE_SCHEMA$|TG_DB_|QSTASH_(CURRENT_SIGNING_KEY|NEXT_SIGNING_KEY|CHAIN_TOKEN)$|CRON_SECRET$|V1_FINALITY_DELAY_)/,
