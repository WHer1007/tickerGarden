...
const configuration={chainId:4663,addresses:m.addresses,dependencies:Object.fromEntries(Object.entries(deps.dependencies).filter(([key])=>!["SWAP_ROUTER","QUOTER"].includes(key))),holderMode:'wallet-snapshot-v1',feePolicyId:hash('TICKERGARDEN_V1_FEE_POLICY_40_30_30'),firstBuyFunding:"wallet-quote-only",rewardClaims:"raw-assets-only",tradingServices:"off-chain"};
