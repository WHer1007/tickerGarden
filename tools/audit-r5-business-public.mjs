...
const dir='outputs/reviews/r5-business-acceptance-2026-09-06/public';const s=JSON.parse(fs.readFileSync(dir+'/results.json')),p=JSON.parse(fs.readFileSync('deployments/manifests/arbitrum-sepolia-421614.v1.deployed.json')),roles=JSON.parse(fs.readFileSync(dir+'/roles.json')).roles;
