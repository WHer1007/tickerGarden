...
export const output=root+'outputs/reviews/arbitrum-continuous-simulation-2026-09-07';
const input=root+'outputs/reviews/arbitrum-continuous-preflight-2026-09-07';
...
export function verifyBatch(batch=read(output+'/unsigned-transactions.json')) {
 ...
 const artifacts=names.map(load), orchestrator=load('V1ArbitrumDeploymentOrchestrator');
 ...
 eq(batch.chain,421614,'Batch chain');eq(batch.transactions.length,19,'Transaction count');
