...
> **Current schema boundary (2026-09-04):** `V1-EXEC-8` removes deployed-market administration and management-recovery role/selector requirements; asset/configuration status and one-way launchPhase facts remain. The schema is locally synchronized but is not evidence of a target-chain deployment.
...
constraints, all 86 AccessManager permission rows and five frozen role bindings (including independent Treasury Root publisher/reviewer members), product/Fork/E2E reports, gate
