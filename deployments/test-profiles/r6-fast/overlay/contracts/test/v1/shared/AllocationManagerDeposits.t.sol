...
import {IAllocationManager, IUserStockVault, PositionView} from "../../../src/v1/interfaces/IV1Protocol.sol";
import {UserStockVault} from "../../../src/v1/modules/UserStockVault.sol";
import {AllocationManagerDeposits} from "../../../src/v1/shared/AllocationManagerDeposits.sol";
...
contract AllocationManagerDepositsTest is Test {
    ...
    function test_depositAndAllocateBindsCallerAndUsesOnlyVaultAllowance() public {
        ...
        assertEq(position.unlockAt, block.timestamp + 20 minutes);
