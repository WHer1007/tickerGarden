...
import { encodeFunctionData } from "../../treasury-root-generator/node_modules/viem/_esm/index.js";
import path from "node:path";
import { fileURLToPath } from "node:url";
import {
  computeEligibilityPolicyHash,
  generateTreasuryRoot,
} from "../../treasury-root-generator/src/index.ts";
...
const WINDOW_END = WINDOW_START + EPOCH;
...
const cases = [
  ...
  },
  {
    ...
    input: input(3, 100n, [
      ...
      transfer(2, 0, 0, WINDOW_START + 1200n, A, B, 40n),
      transfer(3, 0, 0, WINDOW_START + 1800n, B, ZERO, 10n),
      transfer(4, 0, 0, WINDOW_START + 2400n, A, A, 5n),
    ]),
  },
  {
