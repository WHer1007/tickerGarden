...
const spec = {
  openapi: "3.1.0",
  info: { title: "TickerGarden V1 Read API", version: "4.6.0", description: "Non-custodial TypeScript Serverless read API for the routes consumed by the current frontend." },
