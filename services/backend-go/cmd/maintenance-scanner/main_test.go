...
func TestMaintenanceScannerRejectsInvalidUsage(t *testing.T) {
	usage := "usage: maintenance-scanner --describe | --once | --run"
...
func TestMaintenanceScannerDescribe(t *testing.T) {
	var out bytes.Buffer
	...
	if description["marketDiscovery"] != true || description["accountDiscovery"] != true || description["transactionSubmission"] != false {
		t.Fatalf("description = %#v", description)
	}
}

func TestMaintenanceScannerRejectsPollIntervalBeforeManifestOpen(t *testing.T) {
