...
func TestMaintenancePreparerDescribe(t *testing.T) {
	...
	if description["atomicPreparation"] != true || description["transactionSubmission"] != false {
		t.Fatalf("description = %#v", description)
	}
}

func TestMaintenancePreparerRejectsInvalidUsage(t *testing.T) {
	usage := "usage: maintenance-preparer --describe | --once | --run"
...
func TestMaintenancePreparerRejectsPollIntervalBeforeManifestOpen(t *testing.T) {
