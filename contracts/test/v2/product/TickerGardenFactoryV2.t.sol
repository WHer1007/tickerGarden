...
import {LaunchAndBuyRouterERC20} from "../../../src/v2/shared/LaunchAndBuyRouterERC20.sol";
import {LaunchAndBuyRouterNative} from "../../../src/v2/shared/LaunchAndBuyRouterNative.sol";
import {
...
contract FactoryMarketControllerMock {
    bool public allocationOpen;
...
contract FactoryAddressDeployer {
    function deploy(TickerGardenFactoryInit memory init) external returns (TickerGardenFactoryV2) {
        return new TickerGardenFactoryV2(init);
    }
}

contract TickerGardenFactoryV2Test is Test {
    ...
    FactoryMarketControllerMock internal controller;
    ...
    TickerGardenFactoryV2 internal factory;
    ...
    function setUp() public {
        ...
        controller = new FactoryMarketControllerMock();
        ...
        marketRegistry = new MarketRegistryV2(
            predictedFactory,
            address(configs),
            address(configs),
            address(configs),
    ...
    function test_predictAndCreateDeployExactComponentsAndRegisterFullSnapshot() public {
        ...
        assertEq(value.config.marketController, address(controller));
        assertEq(value.runtime.sourceVersion, 1);
        assertEq(value.runtime.launchPhase, 0);
        assertEq(value.runtime.marketStatus, 0);
    ...
    function _assertCurveCreate2(bytes32 marketId, address predictedCurve) private view {
        bytes32 salt =
            V2Identifiers.componentSalt(block.chainid, address(factory), marketId, V2Identifiers.ComponentKind.CURVE);
        bytes32 initCodeHash =
            V2Create2.initCodeHash(type(PonsCompatibleCurve).creationCode, abi.encode(address(factory)));
        assertEq(curveImplementation.initCodeHash(address(factory)), initCodeHash);
        assertEq(predictedCurve, V2Create2.predict(address(factory), salt, initCodeHash));
    }
    ...
    function _assertTokenCreate2(
        ...
        bytes32 salt = V2Identifiers.componentSalt(
            block.chainid, address(factory), marketId, V2Identifiers.ComponentKind.TOKEN
        );
        bytes32 initCodeHash = V2Create2.initCodeHash(
        ...
        assertEq(predictedToken, V2Create2.predict(address(factory), salt, initCodeHash));
    }
    ...
    function test_tokenCurveAndGaugeFreezeThePredictedIdentityWithoutInitializer() public {
        ...
        TickerMemeTokenV2 token = TickerMemeTokenV2(tokenAddress);
    ...
    function test_sameStockAndSaltCanCreateDistinctTypedMarketsButIdenticalIdentityCannotRepeat() public {
        ...
        vm.prank(CREATOR);
        vm.expectRevert(abi.encodeWithSelector(TickerGardenFactoryV2.MarketIdentityAlreadyReserved.selector, firstId));
    ...
    function test_nonFactoryWrongSupplyAndCurveDeploymentCannotSpoofCanonicalMarket() public {
        ...
        TickerMemeTokenV2 fake = TickerMemeTokenV2(fakeAddress);
        ...
        vm.expectRevert(abi.encodeWithSelector(MarketRegistryV2.MarketNotRegistered.selector, marketId));
        ...
        assertEq(TickerMemeTokenV2(canonicalToken).factory(), address(factory));
        assertEq(TickerMemeTokenV2(canonicalToken).initialSupply(), SUPPLY);
        assertEq(TickerMemeTokenV2(canonicalToken).balanceOf(canonicalCurve), SUPPLY);
    }
    ...
    function test_launchFeeMustBeExact() public {
        ...
        vm.prank(CREATOR);
        vm.expectRevert(
            abi.encodeWithSelector(TickerGardenFactoryV2.InvalidLaunchFee.selector, LAUNCH_FEE, LAUNCH_FEE - 1)
        );
    ...
    function test_createMarketForIsRouterOnlyAndUsesExplicitCreatorNamespace() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(V2FactoryValidation.UnauthorizedLaunchRouter.selector, address(this)));
    ...
    function test_allFactoryRegistryConfigClassesFailClosedWithoutReservingIdentity() public {
        ...
        _expectFactoryCreateRevert(
            params, abi.encodeWithSelector(V2FactoryValidation.InactiveAsset.selector, ASSET_UID, uint8(2))
        );
        _setValidConfiguration(address(quote));
        ...
        _expectFactoryCreateRevert(
            params, abi.encodeWithSelector(V2FactoryValidation.InactiveQuote.selector, QUOTE_ID, uint8(2))
        );
        _setValidConfiguration(address(quote));
        ...
        _expectFactoryCreateRevert(
            params,
            abi.encodeWithSelector(
                V2FactoryValidation.InvalidQuoteEconomics.selector, QUOTE_ID, quoteConfig.economicsHash
            )
        );
        _setValidConfiguration(address(quote));
        ...
        _expectFactoryCreateRevert(
            params,
            abi.encodeWithSelector(
                V2FactoryValidation.QuoteBaselineMismatch.selector, quoteConfig.ponsBaselineId, BASELINE_ID
            )
        );
        _setValidConfiguration(address(quote));
        ...
        _expectFactoryCreateRevert(
            params, abi.encodeWithSelector(V2FactoryValidation.InactivePonsBaseline.selector, BASELINE_ID, uint8(2))
        );
        _setValidConfiguration(address(quote));
        ...
        _expectFactoryCreateRevert(
            params, abi.encodeWithSelector(V2FactoryValidation.InactiveLaunchTemplate.selector, TEMPLATE_ID, uint8(2))
        );
        _setValidConfiguration(address(quote));
        ...
        _expectFactoryCreateRevert(
            params, abi.encodeWithSelector(V2FactoryValidation.InactiveLaunchTemplate.selector, TEMPLATE_ID, uint8(1))
        );
        _setValidConfiguration(address(quote));
    ...
    function test_unknownFactoryConfigIdsFailClosedAcrossEveryRegistry() public {
        ...
        _expectFactoryCreateRevert(
            missingAssetParams,
            abi.encodeWithSelector(V2FactoryValidation.InactiveAsset.selector, missingAsset, uint8(0))
        );
        ...
        _expectFactoryCreateRevert(
            missingQuoteParams,
            abi.encodeWithSelector(V2FactoryValidation.InactiveQuote.selector, missingQuote, uint8(0))
        );
        ...
        _expectFactoryCreateRevert(
            ...
            abi.encodeWithSelector(V2FactoryValidation.InactivePonsBaseline.selector, missingBaseline, uint8(0))
        );
        _setValidConfiguration(address(quote));
        ...
        _expectFactoryCreateRevert(
            ...
            abi.encodeWithSelector(V2FactoryValidation.InactiveLaunchTemplate.selector, missingTemplate, uint8(0))
        );
    }
    ...
    function test_templateMustBindTheExactDeploymentImplementations() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                TickerGardenFactoryV2.LaunchTemplateImplementationMismatch.selector,
    ...
    function test_lateTreasuryFailureRollsBackComponentsRegistryEpochAndReservation() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                TickerGardenFactoryV2.LaunchFeeTransferFailed.selector, address(treasury), LAUNCH_FEE
            )
        );
        factory.createMarket{value: LAUNCH_FEE}(params);
    ...
    function test_curveConstructorInitializationFailureRollsBackTokenAndReservation() public {
        ...
        vm.mockCallRevert(
            address(factory),
            abi.encodeWithSelector(TickerGardenFactoryV2.curveInitialization.selector, curve),
            injectedReason
        );
        vm.prank(CREATOR);
    ...
    function test_marketRegistrationFailureRollsBackComponentsFeeEpochAndReservation() public {
        ...
        vm.mockCallRevert(
            ...
            abi.encodeWithSelector(IMarketRegistryV2.registerMarket.selector),
    ...
    function test_curveInitializationIsUnavailableOutsideExactConstructorCallback() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(TickerGardenFactoryV2.CurveInitializationUnavailable.selector, curve));
    ...
    function test_gaugeRemainsAllocationDisabledBeforeGraduation() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(MemeStockGauge.StockAllocationClosed.selector, marketId));
    ...
    function test_launchAndBuyNativeCreatesAndBuysAtomicallyForOuterCaller() public {
        ...
        assertEq(refund, 0);
        assertEq(TickerMemeTokenV2(token).balanceOf(recipient), tokensOut);
    ...
    function test_launchAndBuyERC20TailFillReturnsExactTokenRefundToCreator() public {
        ...
        assertGt(refund, 0);
        assertLt(refund, firstBuyAmount);
        assertEq(TickerMemeTokenV2(token).balanceOf(CREATOR), tokensOut);
    ...
    function test_launchAndBuyUsesImmediateContractCallerAndNeverTxOriginAsCreator() public {
        ...
        assertEq(TickerMemeTokenV2(token).creator(), address(caller));
        assertEq(marketRegistry.market(marketId).config.creatorRevenueBeneficiaryAtCreation, BENEFICIARY);
    }
    ...
    function test_beneficiaryIsTypedRevenueIdentityButNeverReplacesCreatorOrMemeRecipient() public {
        ...
        assertEq(TickerMemeTokenV2(token).creator(), CREATOR);
        assertEq(TickerMemeTokenV2(token).balanceOf(recipient), tokensOut);
    ...
    function test_factorySelectorsMatchCanonicalInterfaceAndNoInitializerExists() public {
        assertEq(TickerGardenFactoryV2.createMarket.selector, ITickerGardenFactoryV2.createMarket.selector);
        assertEq(TickerGardenFactoryV2.createMarketFor.selector, ITickerGardenFactoryV2.createMarketFor.selector);
        assertEq(
            TickerGardenFactoryV2.previewMarketEconomics.selector,
            ITickerGardenFactoryV2.previewMarketEconomics.selector
        );
        assertEq(
            TickerGardenFactoryV2.predictMarketAddresses.selector,
            ITickerGardenFactoryV2.predictMarketAddresses.selector
        );
