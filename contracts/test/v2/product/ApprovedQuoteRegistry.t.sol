...
import {IApprovedQuoteRegistry, QuoteAssetConfig} from "../../../src/v2/interfaces/IV2Protocol.sol";
import {ApprovedQuoteRegistry} from "../../../src/v2/modules/ApprovedQuoteRegistry.sol";
...
contract ApprovedQuoteRegistryTest is Test {
    ...
    bytes32 internal constant NATIVE_CONFIG_ID = 0xb5a193a9938ac71aa0e78e36c38ea3ad011d894b671a25baaa5ef746f29f8472;
    bytes32 internal constant USDG_CONFIG_ID = 0xbbb477fcf5f27a5738e9995055eacd60c468990275919cc0c74c7b01d5f03a67;
    ...
    function _economicsHash(QuoteAssetConfig memory config) private view returns (bytes32) {
        return keccak256(
            abi.encode(
                keccak256("TICKERGARDEN_V2_QUOTE_ECONOMICS"),
                uint256(1),
                block.chainid,
