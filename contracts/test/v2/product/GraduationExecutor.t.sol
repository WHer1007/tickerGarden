...
import {QuoteAssetConfig} from "../../../src/v2/interfaces/IV2Protocol.sol";
import {GraduationExecutor} from "../../../src/v2/modules/GraduationExecutor.sol";
...
contract GraduationExecutorTest is Test {
    ...
    function test_realLockerCreationCodeSaltPredictionAndActualDeploymentMatchManifest() public {
        ...
        bytes32 salt = V2Identifiers.componentSalt(
            block.chainid, registry.factory(), MARKET_ID, V2Identifiers.ComponentKind.LOCKER
        );
        address independentlyPredicted = V2Create2.predict(address(executor), salt, keccak256(lockerInitCode));
