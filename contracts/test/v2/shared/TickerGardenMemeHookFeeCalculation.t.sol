...
import {TickerGardenMemeHookFeeCalculation} from "../../../src/v2/shared/TickerGardenMemeHookFeeCalculation.sol";
...
contract TickerGardenMemeHookFeeCalculationHarness is TickerGardenMemeHookFeeCalculation {
    constructor(address registry, address poolManager, address feeVault, address graduation, address controller)
        TickerGardenMemeHookFeeCalculation(registry, poolManager, feeVault, graduation, controller)
    {}
...
contract TickerGardenMemeHookFeeCalculationTest is Test {
    ...
    HookFeeCalculationDependencyMock private controller;
    ...
    function setUp() public {
        ...
        controller = new HookFeeCalculationDependencyMock();
