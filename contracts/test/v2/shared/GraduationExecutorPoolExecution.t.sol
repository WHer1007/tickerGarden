...
import {GraduationPoolMath} from "../../../src/v2/libraries/GraduationPoolMath.sol";
import {GraduationExecutorPoolExecution} from "../../../src/v2/shared/GraduationExecutorPoolExecution.sol";
...
contract PoolExecutionRegistryMock {
    ...
    function setMarketStatus(uint8 value) external {
        _value.runtime.marketStatus = value;
    }
