// Run-specific fresh pin; generated by tools/service-integration/formal-business-fork.mjs.
...
contract FormalClockRHForkTest is Test {
    uint256 private constant FORK_BLOCK_NUMBER = 56013943;
    bytes32 private constant FORK_BLOCK_HASH = 0xbfef4f4673feadc08f21616ceebe8bea0a84974098ecab0e8d396062ef22db42;
    uint256 private constant FORK_L1_BLOCK_NUMBER = 25918608;
    ...
    function _settleAndClaimHolder(bytes32 marketId, address memeToken, address feeVault) private {
        ...
        // Foundry does not emulate Nitro arbBlockHash; this exact hash was verified over live RPC.
        vm.mockCall(address(100), abi.encodeWithSignature("arbBlockHash(uint256)", FORK_BLOCK_NUMBER - 2), abi.encode(bytes32(0x7464fabd0bceb8c020cf9dd366c79b15d85ce886763a651c604676b8dab51a22)));
        vm.prank(HOLDER);
