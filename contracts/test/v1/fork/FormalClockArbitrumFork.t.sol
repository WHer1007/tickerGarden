...
contract FormalClockArbitrumForkTest is Test {
    uint256 private constant FORK_BLOCK_NUMBER = 306050655;
    bytes32 private constant FORK_BLOCK_HASH = 0xbada25428144ab46fec3563b45662aa1114d483137437142d863785253d734e3;
    ...
    function _settleAndClaimHolder(bytes32 marketId, address memeToken, address feeVault) private {
        ...
        vm.mockCall(address(100), abi.encodeWithSignature("arbBlockHash(uint256)", FORK_BLOCK_NUMBER - 2), abi.encode(bytes32(0x173a491e399e5360d58045204a2b6537eae152a18a56dd5cbe65ffc4b012edf3)));
        vm.prank(HOLDER);
