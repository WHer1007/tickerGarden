...
interface IContinuousTestCurve {
    function buy(uint256, uint256, address) external payable;
    function sweepCurveFees() external;
}

interface IContinuousTestVault {
...
contract ArbitrumContinuousTestDriver {
    ...
    constructor(address vault) {
        require(block.chainid == 421614 && vault.code.length != 0);
        feeVault = vault;
    }
