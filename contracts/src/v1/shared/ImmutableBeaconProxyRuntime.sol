...
library ImmutableBeaconProxyRuntime {
    ...
    bytes32 internal constant RH_TESTNET_TEMPLATE =
        0x03b31ff7bb8349c8d21fe83180506f2319281b960b29ad548c6445948df7b2d3;
    ...
    function beacon(bytes memory runtime) internal pure returns (address) {
        ...
        if (
            normalizedHash != LOCAL_TEMPLATE && normalizedHash != RH_TEMPLATE
                && normalizedHash != RH_TESTNET_TEMPLATE
        ) return address(0);
