...
Production curve buys use `TickerGardenAntiSnipe.sol`: raw bps at elapsed seconds 0–4 are 9900, 2475, 309, 19, 1; zero from second 5. `PonsAntiSnipe.sol` remains a historical differential reference only.
