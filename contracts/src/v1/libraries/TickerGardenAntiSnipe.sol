...
library TickerGardenAntiSnipe {
    uint256 internal constant BPS_DENOMINATOR = 10_000;
    uint256 internal constant MINIMUM_NET_BPS = 100;
    uint256 internal constant CREATOR_TAX_BPS = 0;
    uint256 internal constant SNIPE_TAX_SECONDS = 5;

    uint256 internal constant ELAPSED_0_RAW_BPS = 9_900;
    uint256 internal constant ELAPSED_1_RAW_BPS = 2475;
    uint256 internal constant ELAPSED_2_RAW_BPS = 309;

    uint256 internal constant ELAPSED_3_RAW_BPS = 19;
    uint256 internal constant ELAPSED_4_RAW_BPS = 1;
    ...
    function rawSnipeBps(uint256 elapsedSeconds, bool exempt) internal pure returns (uint256) {
        ...
        if (elapsedSeconds == 2) return ELAPSED_2_RAW_BPS;
        if (elapsedSeconds == 3) return ELAPSED_3_RAW_BPS;
        return ELAPSED_4_RAW_BPS;
    }
