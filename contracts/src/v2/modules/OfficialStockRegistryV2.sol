...
import {AssetView, IOfficialStockRegistryV2} from "../interfaces/IV2Protocol.sol";
...
contract OfficialStockRegistryV2 is IOfficialStockRegistryV2, ImmutableAccessManaged {
    ...
    uint8 internal constant MIN_TOKEN_DECIMALS = 1;
    ...
    mapping(address userStockVault => bytes32 assetUid) private _assetUidByVault;
    ...
    error UserStockVaultAlreadyRegistered(address userStockVault, bytes32 assetUid);
        ...
        restricted
    {
        ...
        bytes32 vaultAssetUid = _assetUidByVault[userStockVault];
        if (vaultAssetUid != bytes32(0)) revert UserStockVaultAlreadyRegistered(userStockVault, vaultAssetUid);
        ...
        _assetUidByVault[userStockVault] = assetUid;
