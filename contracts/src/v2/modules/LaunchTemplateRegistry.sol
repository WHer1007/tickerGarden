...
import {ILaunchTemplateRegistry, LaunchTemplate} from "../interfaces/IV2Protocol.sol";
import {ImmutableAccessManaged} from "../shared/ImmutableAccessManaged.sol";

/// @notice Append-only, code-identity-bound component templates for V2 market launches.
contract LaunchTemplateRegistry is ILaunchTemplateRegistry, ImmutableAccessManaged {
