...
/// @notice Canonical typed hashes for V2 market identity and per-market component namespaces.
library V2Identifiers {
    bytes32 internal constant MARKET_ID_DOMAIN = keccak256("TICKERGARDEN_V2_MARKET_ID");
    bytes32 internal constant COMPONENT_SALT_DOMAIN = keccak256("TICKERGARDEN_V2_COMPONENT_SALT");
