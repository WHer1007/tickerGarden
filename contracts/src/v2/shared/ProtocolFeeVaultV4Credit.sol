...
abstract contract ProtocolFeeVaultV4Credit {
    ...
    IMarketRegistryV2 internal immutable _feeMarketRegistry;
    ...
    constructor(address marketRegistry_, address poolManager_) {
        ...
        _feeMarketRegistry = IMarketRegistryV2(marketRegistry_);
        ...
        view
    {
        ...
        if (
            value.runtime.launchPhase != LAUNCH_PHASE_POOL_CREATED || value.runtime.marketStatus != MARKET_STATUS_ACTIVE
                || value.runtime.poolId == bytes32(0) || value.runtime.sourceVersion != sourceVersion
                || value.config.graduatedHook != source
        ) {
