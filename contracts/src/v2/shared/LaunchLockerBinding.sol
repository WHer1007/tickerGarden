...
abstract contract LaunchLockerBinding {
    ...
    IMarketRegistryV2 internal immutable _lockerMarketRegistry;
    ...
    error LaunchLockerMarketNotSwept(bytes32 marketId, uint8 launchPhase, uint8 marketStatus);
    ...
    constructor(bytes32 marketId_, address marketRegistry_, address positionManager_) {
        ...
        IMarketRegistryV2 registry = IMarketRegistryV2(marketRegistry_);
        ...
        if (
            ...
            revert LaunchLockerMarketNotSwept(marketId_, value.runtime.launchPhase, value.runtime.marketStatus);
        }
