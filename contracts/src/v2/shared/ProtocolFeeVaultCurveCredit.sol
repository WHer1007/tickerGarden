...
import {ICreatorRevenueRegistry, MarketView} from "../interfaces/IV2Protocol.sol";
    ...
    function creditCurveSweep(
        ...
        if (
            value.runtime.launchPhase != LAUNCH_PHASE_NOT_GRADUATED
                || value.runtime.marketStatus != MARKET_STATUS_ACTIVE || value.runtime.sourceVersion != sourceVersion
        ) {
