...
import {PonsBaseline} from "../interfaces/IV2Protocol.sol";

/// @notice Canonical content hashes used by Factory validation and immutable market snapshots.
library V2MarketEconomics {
    bytes32 internal constant PONS_BASELINE_DOMAIN = keccak256("TICKERGARDEN_V2_PONS_BASELINE");
