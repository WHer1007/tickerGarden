...
OUTPUT_PATH = ROOT / "contracts/test/v2/fixtures/v2-fork-fixtures.json"
SOURCE_PATHS = (
    "spec/v2_initial_quote_configs.json",
    "spec/v2_pons_behavior_vectors.json",
    "spec/v2_pons_runtime_evidence.json",
)
MOCK_SOURCE = "contracts/test/v2/mocks/MockV2QuoteAssets.sol"
ARTIFACT_ROOT = ROOT / "contracts/out-v2/MockV2QuoteAssets.sol"
...
def main():
    ...
    if args.check:
        ...
        print(f"V2 fixture manifest verified: {fixture['fixtureSetHash']}")
        return
