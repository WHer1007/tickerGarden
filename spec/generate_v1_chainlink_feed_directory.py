"""Retired V1-EXEC-1 Chainlink directory research capture.

This is historical offchain evidence only. It is not an input to V1-EXEC-3 and
...
def _request() -> bytes:
    request = urllib.request.Request(
        FEED_DIRECTORY_URL,
        headers={"User-Agent": "TickerGarden-V1-Feed-Directory-Capture/1.0"},
    )
