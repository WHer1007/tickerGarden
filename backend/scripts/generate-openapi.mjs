...
const spec = {
  openapi: "3.1.0",
  info: { title: "TickerGarden V1 Read API", version: "1.0.4", description: "Non-custodial read API backed only by reconciled V1 Indexer facts." },
  "x-execution-spec-id": "V1-EXEC-8",
  paths: {
  ...
  components: { schemas: {
    ...
    HealthResponse: object({
      executionSpecId: { type: "string", const: "V1-EXEC-8" }, status: { type: "string", const: "read-api" }, readApiImplemented: { type: "boolean", const: true },
...
const nextLock = { schemaVersion: 1, openapiVersion: spec.info.version, executionSpecId: "V1-EXEC-8", fingerprint };
