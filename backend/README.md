...
`V1-EXEC-9`; any changed schema without a version increase fails closed. CI uses
...
for deterministic tests. It accepts only `V1-EXEC-9` snapshots carrying zero I502
