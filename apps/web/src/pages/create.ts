...
<main class="page">
      ...
      <div class="create-layout">
        ...
        <aside class="panel token-preview" aria-labelledby="preview-heading">
          ...
          <div class="preview-list"><div><span>Launch fee</span><strong data-preview-launch-fee>${FIXED_LAUNCH_FEE_LABEL}</strong></div><div><span>Paired with</span><strong data-preview-quote>-</strong></div><div><span>Base trade fee</span><strong data-preview-trade-fee>-</strong></div><div><span>LP fee</span><strong data-preview-lp-fee>0%</strong></div><div><span>Bloom target</span><strong data-preview-graduation>-</strong></div><div><span>Liquidity</span><strong>Locked when Bloomed</strong></div><div><span>Staking asset</span><strong data-preview-asset>-</strong></div><div><span>Developer buy</span><strong data-preview-mode>-</strong></div><div><span data-preview-burn-label>Burn your token</span><strong data-preview-meme-burn>Off</strong></div><div><span>Creator tax</span><strong data-preview-creator-tax>0%</strong></div><div><span>Holder fee sharing</span><strong data-preview-treasury>Off</strong></div></div>
