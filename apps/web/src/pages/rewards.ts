        ...
        <div class="holder-content">
          <div class="rewards-panel-head">
            ...
            <div data-continuous-treasury hidden>
              ...
              <details class="holder-pool-details"><summary>Market reward pool</summary><dl class="claim-facts"><div><dt>Fees being collected</dt><dd data-continuous-unswept>-</dd></div><div><dt>Token rewards being prepared</dt><dd data-continuous-conversion>-</dd></div><div><dt>Rewards being prepared</dt><dd data-continuous-pending>-</dd></div><div><dt>Releasing</dt><dd data-continuous-release>-</dd></div><div><dt>Upcoming rewards</dt><dd data-continuous-idle>-</dd></div><div><dt>Last reward update</dt><dd data-continuous-funding>-</dd></div></dl><small>These totals cover the whole market. Rewards are released in 24-hour periods; your available amount is shown above.</small></details>
