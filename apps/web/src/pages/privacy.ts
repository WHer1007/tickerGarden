...
<main class="page legal-page">
      <section class="page-hero">
        <div>
          <div class="kicker"><i class="ph ph-shield-check" aria-hidden="true"></i>TickerGarden legal</div>
      ...
      <div class="legal-layout">
        <nav class="legal-toc" aria-label="Privacy Policy contents">
          ...
          <ol>
            ...
            <li><a href="#privacy-rights">Rights and choices</a></li>
            <li><a href="#privacy-children">Children</a></li>
            <li><a href="#privacy-changes">Changes and contact</a></li>
          </ol>
        </nav>
