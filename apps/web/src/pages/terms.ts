      ...
      <div class="legal-layout">
        ...
        <article class="legal-document">
          ...
          <section id="terms-treasury">
            ...
            <p>This opt-in is immutable at market creation. When selected, 50% of the creator base fee share, excluding creator tax, is earmarked for holders. The creator retains the other 50% of the base fee share and 100% of creator tax; holder amounts are settled in Quote through the existing background workflow. Eligibility uses 7-day balance-time-weighted records. No extra per-user deposit step is required.</p>
            <p>The platform may trigger the existing Root process. Roots, review, proof publication, claim windows, and payouts can be delayed or unavailable; a generated or reviewed root does not guarantee instant payment, token value, legal entitlement outside the protocol, or error-free data.</p>
          </section>
