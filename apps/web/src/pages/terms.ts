      ...
      <div class="legal-layout">
        <nav class="legal-toc" aria-label="Terms of Use contents">
          ...
          <ol>
            ...
            <li><a href="#terms-assets">Ticker Meme and STOCK</a></li>
        ...
        <article class="legal-document">
          ...
          <section id="terms-fees">
            ...
            <p>Market creators, active matching-STOCK allocators, and the platform may receive portions of fees actually generated by the relevant market under its applicable rules. Fee assets may be Quote assets or Ticker Meme tokens. Amounts can be zero, volatile, illiquid, delayed, unclaimable because of technical failure, or worth less when claimed.</p>
            <p>Where selected at creation, Meme fee burn mode is immutable. Creator and Staker Meme fees, including creator tax, are destroyed when a reward claim is processed, including a Quote-only claim; their Quote fees continue to be paid normally. Holder Meme fees are destroyed by FeeVault during funding settlement and are not funded to the HolderRewardsDistributor, so holder snapshots cover Quote only. Burn occurs during settlement, never on swaps or transfers, and reduces token supply through the token’s burn mechanism rather than a dead-address transfer. Unclaimed Creator and Staker fees remain pending until settlement. Platform fees are unaffected.</p>
            <p>STOCK allocation does not mint Ticker Meme tokens and is not a fixed-income, savings, brokerage, dividend, or guaranteed-yield product. No displayed annualized rate, estimate, historical fee amount, or “Harvest” label is a promise of future return. You are responsible for taxes and reporting arising from creation, trading, allocation, and claims.</p>
          </section>
          ...
          <section id="terms-treasury">
            ...
            <p>For the snapshot model, FeeVault funds the HolderRewardsDistributor and a trusted publisher commits a wallet-balance snapshot root. Only direct wallet Meme balance at the snapshot is included; LP and other indirect holdings are excluded. Selling after the snapshot does not remove that round’s entitlement. Publication cadence is an off-chain policy, and the contract does not promise a fixed 24-hour or 7-day payout period.</p>
            <p>Claims pay the selected raw Quote and/or Ticker Meme asset. The protocol does not convert one reward asset into the other or provide an on-chain fallback. Rewards can be delayed, unavailable, or worth less when received, and no displayed estimate guarantees payment time or token value.</p>
            <p>For markets with Meme fee burn mode, the Holder snapshot and claimable holder reward are Quote only. The burn setting cannot be changed after market creation.</p>
          ...
          <section id="terms-use">
            ...
            <ul>
              ...
              <li>misrepresent a Ticker Meme as stock, tokenized equity or debt, a dividend right, a redeemable claim, or an officially endorsed company asset;</li>
