...
| Quote | 首发批准 native + USDG；协议保留多 Quote 能力，每市场永久选择一个 Quote | 权威配置见 [`spec/v1_initial_quote_configs.json`](./spec/v1_initial_quote_configs.json)；部署前必须重新获取可升级 USDG 的 implementation/codehash 指纹 |
