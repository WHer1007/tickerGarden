...
const READ_API_URL = "VITE_V1_READ_API_URL";
const ADDRESS_KEYS = [
...
function normalizeBaseUrl(value: string): string | undefined {
  ...
  // Generated API routes are rooted at /health and /v1. Accepting a base path
...
/**
 * Parse the explicit V1 runtime settings supplied by the caller.
 *
